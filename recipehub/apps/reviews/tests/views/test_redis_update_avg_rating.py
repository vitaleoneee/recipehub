...
class TestRedisReviewRating:
    """Tests that creating reviews updates redis sorted set for ratings"""

    def test_review_creates_redis_rating(self, client, users_list, fake_redis):
