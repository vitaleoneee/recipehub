...
class TestRecipeDetailSendComment:
    """Tests for sending comments on recipe detail page"""

    def test_send_comment_without_data(self, client, users_list):
    ...
    def test_send_comment_with_data(self, client, users_list):
        user = users_list["first_simple_user"]
        recipe = RecipeFactory.create(moderation_status="approved")
        client.force_login(user)
