...
class TestRecipeDetailComment:
    """Tests for comments display and pagination on recipe detail"""

    def test_recipe_detail_comment(self, client, users_list):
        # Testing comment display and pagination
        comment_owner_user = users_list["recipe_owner_user"]
        ...
        CommentFactory.create_batch(
            4, user=second_simple_user, recipe=recipe_from_comment_owner_user
        )
