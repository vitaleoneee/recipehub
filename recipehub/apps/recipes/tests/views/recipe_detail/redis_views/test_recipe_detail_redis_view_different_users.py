...
class TestRecipeDetailRedisViewDifferentUsers:
    """Tests counting views from different users via redis"""

    def test_recipe_detail_redis_view_different_users(
        self, client, users_list, fake_redis
    ):
