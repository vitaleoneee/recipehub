...
from recipehub.apps.recipes.tests.utils.factories import RecipeFactory, UserFactory
...
@pytest.mark.parametrize(
    "filename,expected_path",
    [
        ("hello-world.JPG", "recipes/test/fish/a596b366-befa-42d1-870a-b4e7fddd9eba.jpg"),
        ("1hellO1.png", "recipes/test/fish/a596b366-befa-42d1-870a-b4e7fddd9eba.png"),
        ("TEST1234.jpeg", "recipes/test/fish/a596b366-befa-42d1-870a-b4e7fddd9eba.jpeg")
    ]
)
def test_success_recipe_photo_upload_to(filename, expected_path, mocker):
    ...
    mocker.patch("recipehub.apps.recipes.utils.uuid.uuid4", return_value="a596b366-befa-42d1-870a-b4e7fddd9eba")
